...
public class TicTacToe {
    ...
    //if taking center is also not possible declaring game over
    public void uc12_tillGameOver() {
       if(win == 1 || (board[1] != ' ' && board[2] != ' ' && board[3] != ' ' && board[4] != ' ' && board[5] != ' ' && board[6] != ' ' && board[7] != ' ' && board[8] != ' ' && board[9] != ' '))
       {
           System.out.println("Game over");
           uc13_playAgain();
       }
    }
    //providing option for the player to play again after the game ends
